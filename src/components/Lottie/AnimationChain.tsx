  ...
  return {
    ...
    async prepare() {
      if (players === undefined) {
        ...
        const [lottie, jsons] = await Promise.all([
          lottiePromise,
          jsonsPromise,
        ]);
        const sourceUrl =
          animationInfos.length === 1 && 'url' in animationInfos[0]
            ? animationInfos[0].url
            : undefined;
